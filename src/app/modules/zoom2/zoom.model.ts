...
export const ZoomMeeting = mongoose.model<IZoomMeeting>("ZoomMeeting2", ZoomMeetingSchema);
export const ZoomRecording = mongoose.model<IZoomRecording>("ZoomRecording2", ZoomRecordingSchema);
